...
exec > log/${sample_name}/straingr_test.log
exec 2>&1
...
SORTED_BAM="straingr_test/${sample_name}/alignments.sorted.bam"
METRICS="straingr_test/${sample_name}/alignments.duplicate_metrics.txt"
BAM="straingr_test/${sample_name}/alignments.bam"
