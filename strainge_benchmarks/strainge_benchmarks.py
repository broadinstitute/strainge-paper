...
def bwa_index_files(path):
    """Get list of corresponding BWA index files for a given reference fasta
    file. Useful as snakemake rule input that performs BWA alignment."""
